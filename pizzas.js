let pizzaJson = [
    {id:1, name:'Mussarela', img:'images/pizza.png', price:20.19, sizes:['Pequena(4 pedaços)', 'Média(6 pedaços', 'Grande(8 pedaços)'], description:'Descrição da pizza em mais de uma linha muito legal bem interessante'},
